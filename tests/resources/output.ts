...
export const testScalars = query<testScalars_variables, testScalars_data>(gql`query testScalars {
  scalarString
  scalarInt
  scalarFloat
  scalarBoolean
...
export const testNullability = query<testNullability_variables, testNullability_data>(gql`query testNullability {
  nullableBoolean
  nonNullableBoolean
}`)
...
export const testNesting = query<testNesting_variables, testNesting_data>(gql`query testNesting {
  nestedObject {
    recursive {
      recursive {
        scalar
...
export const testMethods = query<testMethods_variables, testMethods_data>(gql`query testMethods(
  $reqParam: String!
  $optParam: Float!
  $input: InputType
  $list2: [CustomScalar!]!
...
export type testMethods_data = {
  ...
  renamedMethod?: Nullable<ReadonlyArray<Nullable<testMethods_data_renamedMethod>>>
}
export type testMethods_data_method = any
export type testMethods_data_renamedMethod = any

export const testScalarsMutation = mutation<testScalarsMutation_variables, testScalarsMutation_data>(gql`mutation testScalarsMutation {
  scalarString
  scalarInt
  scalarFloat
  scalarBoolean
...
export const testNullabilityMutation = mutation<testNullabilityMutation_variables, testNullabilityMutation_data>(gql`mutation testNullabilityMutation {
  nullableBoolean
  nonNullableBoolean
}`)
...
export const testNestingMutation = mutation<testNestingMutation_variables, testNestingMutation_data>(gql`mutation testNestingMutation {
  nestedObject {
    recursive {
      recursive {
        scalar
...
export type testNestingMutation_data_nestedObject_recursive_recursive = {
  scalar?: Nullable<testNestingMutation_data_nestedObject_recursive_recursive_scalar>
}
...
export const testMethodsMutation = mutation<testMethodsMutation_variables, testMethodsMutation_data>(gql`mutation testMethodsMutation(
  $reqParam: String!
  $optParam: Float!
  $input: InputType
  $list2: [CustomScalar!]!
...
export type testMethodsMutation_data = {
  ...
  renamedMethod?: Nullable<ReadonlyArray<Nullable<testMethodsMutation_data_renamedMethod>>>
}
