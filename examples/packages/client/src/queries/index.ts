...
export const getAllTodos = query<getAllTodos_variables, getAllTodos_data>(gql`query getAllTodos {
  todoItems {
    id
    title
    isDone
...
export const createTodo = mutation<createTodo_variables, createTodo_data>(gql`mutation createTodo($todoItem: TodoItemInput!) {
